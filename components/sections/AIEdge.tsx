...
const aiCapabilities = [
  ...
  },
  {
    icon: Zap,
    title: "러닝 커브 감소",
    description: "새로운 라이브러리, 프레임워크, 툴을 빠르게 익히고 프로젝트에 적용하여 개발 속도 향상",
  },
  {
    icon: Sparkles,
    title: "반복 작업 자동화",
...
const aiHighlights = [
  ...
  "프로젝트 인원이 퇴사하여 인수인계받은 코드베이스 분석에 AI 활용",
  "이미 구축되어 있는 Kubernetes 환경에 MCP 연동을 통한 사용성 개선",
  "퍼블리싱이 메인이 되는 웹 이력서를 하루 만에 개발 및 배포",
  "개인 미니 PC에 Docker 환경 구축 및 관리 도움",
  "토이 프로젝트 중 경험이 없던 안드로이드 앱 개발을 바이브 코딩으로 실제 사용 가능한 수준까지 완성",
];
